  ...
  return (
    <div className="mx-auto max-w-md space-y-6">
      ...
      <div className="space-y-2 text-center">
        ...
        <p className="text-zinc-500 dark:text-zinc-400">Fill out the information of the new citizen</p>
      </div>
      <form
        onSubmit={(e) => {
          e.preventDefault()
      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input name="age" id="age" required type="number" placeholder="33" />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input name="someNote" id="someNote" required placeholder="Cool Web3 dev" />
          </div>
